...
PFNGLBINDIMAGETEXTUREARBPROC glad_glBindImageTextureARB = NULL;
PFNGLMEMORYBARRIERARBPROC glad_glMemoryBarrierARB = NULL;
...
static void load_GL_ARB_shader_image_load_store(GLADloadproc load) {
	...
	glad_glBindImageTextureARB = (PFNGLBINDIMAGETEXTUREARBPROC)load("glBindImageTexture"); //ARB
	glad_glMemoryBarrierARB = (PFNGLMEMORYBARRIERARBPROC)load("glMemoryBarrier"); //ARB
}
...
int gladLoadGLLoader(GLADloadproc load) {
	...
	{
		glad_glBindImageTexture = (PFNGLBINDIMAGETEXTUREPROC)glad_glBindImageTextureARB;
		glad_glMemoryBarrier = (PFNGLMEMORYBARRIERPROC)glad_glMemoryBarrierARB;
	}
	else if (GLAD_GL_EXT_shader_image_load_store)
	{
		glad_glBindImageTexture = (PFNGLBINDIMAGETEXTUREPROC)glad_glBindImageTextureEXT;
