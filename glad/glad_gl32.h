/*
    ...
    OpenGL loader generated by glad 0.1.29 on Mon Apr  8 22:46:18 2019.
...
#define GL_SHADER_IMAGE_ACCESS_BARRIER_BIT_ARB 0x00000020
...
typedef void (APIENTRYP PFNGLBINDIMAGETEXTUREARBPROC)(GLuint unit, GLuint texture, GLint level, GLboolean layered, GLint layer, GLenum access, GLenum format);
GLAPI PFNGLBINDIMAGETEXTUREARBPROC glad_glBindImageTextureARB;
#define glBindImageTextureARB glad_glBindImageTextureARB
typedef void (APIENTRYP PFNGLMEMORYBARRIERARBPROC)(GLbitfield barriers);
GLAPI PFNGLMEMORYBARRIERARBPROC glad_glMemoryBarrierARB;
#define glMemoryBarrierARB glad_glMemoryBarrierARB
#endif
...
typedef void (APIENTRYP PFNGLBINDIMAGETEXTUREPROC)(GLuint index, GLuint texture, GLint level, GLboolean layered, GLint layer, GLenum access, GLint format);
